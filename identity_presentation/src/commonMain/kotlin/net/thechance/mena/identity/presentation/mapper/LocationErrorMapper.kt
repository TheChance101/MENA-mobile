...
internal fun mapLocationErrorToMessage(error: LocationErrorState): StringResource {
    return when (error) {
        ...
        LocationErrorState.FailedToRequestPermission -> Res.string.error_permission_not_granted
        LocationErrorState.UnableToFindLocation -> Res.string.error_location_permission_denied
